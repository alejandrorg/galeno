 ...
 *         &lt;element name="saveToFavouriteId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "SearchConcepts")
public class SearchConcepts {
    ...
    @XmlElementRef(name = "saveToFavouriteId", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> saveToFavouriteId;
    ...
    @XmlElementRef(name = "searchMode", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> searchMode;
    ...
    /**
     * Gets the value of the saveToFavouriteId property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getSaveToFavouriteId() {
        return saveToFavouriteId;
    }

    /**
     * Sets the value of the saveToFavouriteId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setSaveToFavouriteId(JAXBElement<String> value) {
        this.saveToFavouriteId = (value);
    }
     ...
     *     
     */
    public JAXBElement<String> getSearchMode() {
        return searchMode;
    }
     ...
     *     
     */
    public void setSearchMode(JAXBElement<String> value) {
